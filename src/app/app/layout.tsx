...
import { getMarketState } from "@/lib/market/replay-provider";
      ...
      <div className="app-main">
        <header className="app-topbar">
          <div style={{ display: "flex", gap: ".6rem", alignItems: "center" }}>
            <span className="status-pill" style={{ color: marketState === "open" ? "var(--positive)" : "var(--muted)" }}><Clock3 size={13} /> Replay market {marketState}</span>
